          ...
          <div className="relative z-[2] mx-auto grid w-full max-w-[1440px] tablet:grid-cols-2">
            <div className="flex flex-col items-start gap-[24px] tablet:col-start-2 tablet:pl-[30px] desktop:pl-0">
              <Reveal
                ...
                initialY={80}
                duration={1.2}
                className="accent-room clip-room [--accent-room:26px] [--clip-room:4px]"
              >
                <p className="mb-[16px] text-[12px] font-medium uppercase leading-[1.2] tracking-[-0.01em] text-white/60">
              ...
              <p className="max-w-[460px] text-[16px] font-medium leading-[1.5] tracking-[-0.01em] text-white/80">
                {t.hero.resume}
              </p>
              <CopierPrompt
                prompt={prompt}
